...
const heaven_1 = require("@entities/heaven");
...
class DocumentController {
    ...
    throwDice(playerId, gameDocument) {
        ...
        var newHeaven = new heaven_1.Heaven(result1, result2, gameDocument.data.heaven[0].players);
    ...
    shuffleDeck(gameDocument) {
        ...
        listOfCards.forEach((card) => {
            var newCard = new card_1.Card(card.title, card.description);
    ...
    drawCard(gameDocument) {
        ...
        var card = new card_1.Card(gameDocument.data.cards[0].title, gameDocument.data.cards[0].description);
